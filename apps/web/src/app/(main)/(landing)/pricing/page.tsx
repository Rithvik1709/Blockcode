...
const blockcodeFeatures = [
  {
    id: 1,
    title: "Blockcode Advanced search tool",
    description:
  ...
  {
    id: 3,
    title: "30 days Blockcode challenge sheet",
    description: [
...
const whySub = [
  {
    content:
      "Currently, Blockcode 2.0 is in progress (70% done) so till the launch, we are offering premium plan at a discounted price - $49 for the whole year",
  },
  {
    content:
  ...
  {
    content:
      "After the launch, this $49 offer be removed and Blockcode premium will be around ~ $120 for whole year ($10/mo.)",
  },
  {
...
const freePlanCard = {
  ...
  whatYouGetAfterLaunch: [
    ...
    "30 days blockcode challenge sheet",
  ],
};
...
const Pricing = () => {
  ...
  <Header title="We are working on Blockcode 2.0" />
        <div className="flex flex-col bg-[#151515]/20 backdrop-blur-xl relative w-full ">
          <div className="h-full  pv relative">
            ...
            <div className=" w-full h-full flex flex-col gap-6  border-b border-[#252525]">
              <ul className="flex flex-col lg:flex-row [&>li]:w-full  [&>li]:p-6 divide-y lg:divide-y-0 lg:divide-x divide-[#252525] h-full ">
                {blockcodeFeatures.map((feature, index) => {
                  return (
                    <motion.li
                      initial={{ opacity: 0, y: 30, filter: "blur(10px)" }}
                      animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          ...
          <div className="h-full  relative ">
            <div className="py-8 border-b border-[#252525]">
                ...
                className="text-center text-3xl tracking-tight font-medium"
              >
                Why should you subscribe to Blockcode premium now?
              </motion.h2>
            </div>
    ...
    <div className="flex flex-col gap-2">
      ...
      {showPremium && (
        <div className="bg-gradient-to-b from-[#ad84e7] via-[#986cd6] to-[#432d8e] bg-clip-text text-transparent">
          <p className="">Blockcode Premium</p>
        </div>
      )}
    </div>
  );
...
const TestimonialsSection = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "My experience with your guidance and Blockcode has been great. Your tips have really helped in doing my tasks quicker and better. And I would definitely recommend others to opt for Blockcode premium.",
      column: 1,
    },
    {
      id: 3,
      ...
      content: (
        <div className="space-y-3 text-pretty">
          <p>
            Okay so there are a few things I genuinely value about Blockcode
          ...
          <ul className="list-disc space-y-3 pl-6">
            ...
            <li>
              Overall, I&apos;d absolutely recommend Blockcode Premium to anyone
