      ...
      <div className="max-w-4xl mx-auto px-4 py-16 lg:py-24">
        ...
        <div className="space-y-8 text-[#e1e1e1] leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-4">
              Blockcode.ai is a platform designed to help developers discover and
          ...
          <section>
            ...
            <p className="mb-4">When using Blockcode.ai, you agree NOT to:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <p className="mb-4">
              Blockcode.ai offers premium subscription plans with enhanced
              features including:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              Privacy Policy. By using Blockcode.ai, you consent to such
          ...
          <section>
            ...
            <p>
              Blockcode.ai aggregates information about open-source projects
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              functionality of Blockcode.ai (including but not limited to text,
              graphics, logos, software, and design) are owned by Blockcode.ai and
            ...
            <p className="mb-4">
              ...
              open-source projects displayed on Blockcode.ai remains subject to
          ...
          <section>
            ...
            <p className="mb-4">
              <strong>AS-IS BASIS:</strong> Blockcode.ai is provided "AS IS" and
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, Blockcode.ai, its founders
            ...
            <p className="mt-4">
              ...
              Blockcode.ai in the twelve (12) months preceding the claim, or $100,
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless Blockcode.ai and
          ...
          <section>
            ...
            <p className="mt-4">
              Your continued use of Blockcode.ai after changes take effect
          ...
          <section>
            ...
            <p className="mb-4">
              Any disputes arising from these Terms or your use of Blockcode.ai
              shall be resolved through:
            </p>
            <ol className="list-decimal list-inside space-y-2 ml-4">
              <li>
                <strong>Informal Resolution:</strong> Contact us at
                hi@blockcode.ai to attempt good-faith resolution
              </li>
              <li>
          ...
          <section className="border-t border-[#252525] pt-8">
            <p className="text-base italic text-[#b1b1b1]">
              By using Blockcode.ai, you acknowledge that you have read,
