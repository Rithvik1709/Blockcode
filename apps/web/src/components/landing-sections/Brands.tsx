...
const Brands = () => {
  // TODO: Replace with correct trpc procedure names for stats
  // const { data: queryData, isLoading: queryLoading } = trpc.stats.getQueryCount.useQuery();
  // const { data: userData, isLoading: userLoading } = trpc.stats.getUserCount.useQuery();
  ...
  // Placeholder values until backend procedures are available
  const queryCount = "0+";
  const userCount = "0+";
