    ...
    <div className="w-full h-[50dvh] lg:h-[69dvh] relative overflow-hidden z-10 p-4 lg:p-[60px] flex flex-col items-center justify-center gap-6 ">
      ...
      <div className="w-full lg:max-w-3xl space-y-3 text-center">
        ...
        <motion.h1
          ...
          className="text-5xl text-[2.6rem] lg:text-6xl lg:text-[4rem] font-medium tracking-tighter"
        >
          BlockCode - Learn Blockchain by Coding
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 30, filter: "blur(10px)" }}
          animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
          ...
          className="w-full lg:text-xl tracking-tight font-light sm:max-w-lg mx-auto lg:max-w-4xl text-[#e1e1e1]"
        >
          Ace Blockchain problems by coding them out. 
